...
export RECORD_NAME="www" 
export DOMAIN_NAME="aosnoteproject.com" 
export WEB_FILES_S3_URI="s3://YOUR-BUCKET-NAME/nest/nest.zip"
export SERVICE_PROVIDER_FILE_S3_URI="s3://YOUR-BUCKET-NAME/nest/AppServiceProvider.php"
